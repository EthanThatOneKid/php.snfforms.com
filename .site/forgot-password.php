...
<div id="menu_space"></div>
	...
	<div style="font-size: 14px; text-align: center; padding-top: 100px; padding-bottom: 10px;">Please enter your email address.</div>
	<table border="0" cellspacing="5" cellpadding="0" align="center" style="line-height: 30px; font-size: 14px;">
		<tr>
			...
			<td><input name="email" type="text" value class="text_input" maxlength="255"></td>
		</tr>
	</table>
	<input name="submit" type="hidden" value="Send">
	<div style="text-align: center; margin-top: 15px;"><input type="image" src="images/button_send.gif" alt="Login" border="0"></div>
	</form>
